...
const PLANTS = [
  ...
  { id: "kansas-city",        name: "Kansas City Assembly",        city: "Claycomo, MO", country: "USA",        region: "americas", lat: 39.2253, lng: -94.5178, vehicles: ["Ford F-150", "Ford Transit", "Ford E-Transit"] },
  ...
  { id: "detroit-chassis",    name: "Detroit Chassis Plant",       city: "Detroit, MI", country: "USA",         region: "americas", lat: 42.4106, lng: -83.0430, vehicles: ["Ford Stripped Chassis"] },
  { id: "rouge-ev",           name: "Rouge Electric Vehicle Center", city: "Dearborn, MI", country: "USA",      region: "americas", lat: 42.3033, lng: -83.1617, vehicles: ["(Preparing — F-150 Lightning EREV)"] },
  ...
  { id: "multimatic",         name: "Multimatic Markham",          city: "Markham, Ontario", country: "Canada", region: "americas", lat: 43.8561, lng: -79.3370, vehicles: ["Ford Mustang GTD"] },
  ...
  /* ── Spain ── */
  { id: "valencia",           name: "Valencia Body & Assembly",    city: "Almussafes, Valencia, Spain", country: "Spain", region: "europe", lat: 39.2830, lng: -0.4056, vehicles: ["Ford Kuga"] },
  ...
  /* ── Romania ── */
  { id: "craiova",            name: "Craiova Assembly",            city: "Craiova, Romania",  country: "Romania", region: "europe", lat: 44.3302, lng: 23.7948, vehicles: ["Ford Puma", "Ford Puma Gen-E", "Ford Transit Courier", "Ford Tourneo Courier"] },

  /* ── Turkey ── */
  { id: "golcuk",             name: "Ford Otosan Gölcük Plant",    city: "Gölcük, Turkey",    country: "Turkey",  region: "europe", lat: 40.7021, lng: 29.8225, vehicles: ["Ford Transit", "Ford E-Transit"] },
  { id: "yeni-koy",           name: "Ford Otosan Yeniköy Plant",   city: "Kocaeli, Turkey",   country: "Turkey",  region: "europe", lat: 40.7500, lng: 29.9800, vehicles: ["Ford Transit Custom", "Ford Tourneo Custom", "Ford E-Transit Custom", "Ford E-Tourneo Custom"] },

  /* ── China ── */
  { id: "chongqing",          name: "Changan Ford Chongqing",      city: "Chongqing, China", country: "China",  region: "asia", lat: 29.563,  lng: 106.552,  vehicles: ["Ford Escape", "Ford Mondeo", "Lincoln Corsair", "Lincoln Zephyr"] },
  ...
  { id: "harbin",             name: "Changan Ford Harbin",         city: "Harbin, China",    country: "China",  region: "asia", lat: 45.8038, lng: 126.5349, vehicles: ["(Production status unconfirmed)"] },
  { id: "jmc-xiaolan",        name: "JMC Xiaolan Plant",           city: "Nanchang, China",  country: "China",  region: "asia", lat: 28.7200, lng: 115.8500, vehicles: ["Ford Bronco", "Ford Ranger", "Ford Transit", "Ford Tourneo"] },
  { id: "jmc-fushan",         name: "JMC Fushan Plant",            city: "Nanchang, China",  country: "China",  region: "asia", lat: 28.6400, lng: 115.9100, vehicles: ["Ford Territory", "Ford Equator", "Ford Equator Sport"] },

  /* ── Thailand ── */
  { id: "thailand-ftm",       name: "Ford Thailand Manufacturing", city: "Rayong, Thailand",  country: "Thailand", region: "asia", lat: 12.7987, lng: 101.3233, vehicles: ["Ford Ranger", "Ford Ranger Raptor"] },
  { id: "thailand-aat",       name: "AutoAlliance Thailand",       city: "Rayong, Thailand",  country: "Thailand", region: "asia", lat: 12.7480, lng: 101.1650, vehicles: ["Ford Everest", "Ford Ranger"] },

  /* ── Taiwan ── */
  { id: "taoyuan",            name: "Ford Lio Ho Assembly",        city: "Taoyuan, Taiwan",   country: "Taiwan",   region: "asia", lat: 24.9936, lng: 121.301,  vehicles: ["Ford Focus", "Ford Kuga"] },

  /* ── Vietnam ── */
  { id: "hai-duong",          name: "Ford Vietnam Assembly",       city: "Hai Duong, Vietnam", country: "Vietnam", region: "asia", lat: 20.9373, lng: 106.3147, vehicles: ["Ford Transit", "Ford Ranger", "Ford Territory"] },

  /* ── South Africa ── */
  { id: "silverton",          name: "Silverton Assembly Plant",    city: "Pretoria, South Africa", country: "South Africa", region: "africa", lat: -25.7478, lng: 28.3231, vehicles: ["Ford Ranger"] },
];
